...
combine.gsea.dgidb<-function(sampleID, dataDir, pathwayFile){
	...
	enrichedGeneSet $totalThListsEnriched=rowSums(enrichedGeneSet[, grepl("enriched_in", colnames(enrichedGeneSet ))])
...
combine.gsea.dgidb("TH01_0057_S01", "~/downloads/tmp/TH01_0057_S01", "~/downloads/msigdb.v5.2.symbols.gmt")
